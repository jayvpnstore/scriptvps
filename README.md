# Script Jay-Tech (Websocket)
 Welcome Dear😊

 <h2 align="center">AutoScript VPN By Jay-Tech <img src="https://img.shields.io/badge/Version-1.0-blue.svg"></h2>
...
## INSTALLATION SCRIPT
  ...
  ```html
  sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/jayvpnstore/scriptvps/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
...
![IMG_20220403_221826](https://user-images.githubusercontent.com/90880369/161432517-9a32bea7-0a07-4f90-95ea-efdc2e4a8c03.jpg)
